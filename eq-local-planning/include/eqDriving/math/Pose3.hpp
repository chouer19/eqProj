...
//#include "eqDriving/math/config.hpp"
...
namespace eqDriving
{
  ...
  {
    //
    /// \class Pose3 Pose3.hh eqDriving/math/Pose3.hh
    ...
    class Pose3
    {
      ...
      public: friend std::ostream &operator<<(
                  std::ostream &_out, const eqDriving::math::Pose3<T> &_pose)
      {
      ...
      public: friend std::istream &operator>>(
                  std::istream &_in, eqDriving::math::Pose3<T> &_pose)
      {
        // Skip white spaces
