...
#include "eqDriving/math/Angle.hpp"
#include "eqDriving/math/Vector3.hpp"
#include "eqDriving/math/Matrix3.hpp"
...
namespace eqDriving
{
  namespace math
  {
    ...
    /// \class Quaternion Quaternion.hh eqDriving/math/Quaternion.hh
    ...
    class Quaternion
    {
      ...
      public: friend std::ostream &operator<<(std::ostream &_out,
                  const eqDriving::math::Quaternion<T> &_q)
      {
      ...
      public: friend std::istream &operator>>(std::istream &_in,
          eqDriving::math::Quaternion<T> &_q)
      {
