...
namespace eqDriving
{
  ...
  {
    //
    /// \class Vector3 Vector3.hh eqDriving/math/Vector3.hh
    ...
    class Vector3
    {
      ...
      {
        return this->data[clamp(_index, EQ_ZERO_SIZE_T, EQ_TWO_SIZE_T)];
      }
      ...
      public: friend std::ostream &operator<<(
                  std::ostream &_out, const eqDriving::math::Vector3<T> &_pt)
      {
      ...
      public: friend std::istream &operator>>(
                  std::istream &_in, eqDriving::math::Vector3<T> &_pt)
      {
        // Skip white spaces
