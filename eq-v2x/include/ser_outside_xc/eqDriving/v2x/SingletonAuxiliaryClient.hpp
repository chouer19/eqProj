...
#include "ser_outside_xc/thirdParty/simdjson/simdjson.hpp"
...
//        getRequestStatus_respond_t getRequestStatus(const int &_type);
        ...
        string loadFinish();
        string loadFinish(const bool &_is_hard);
        string loadFinish(const string &_vin, const string &_driver_id, const bool &_is_hard);
        //string loadFinish();
